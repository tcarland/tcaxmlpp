...
/**  A utility class of static methods that provide some convenient (java-like) 
...
class StringUtils {
  ...
  public:
    ...
    static bool equals           ( const std::string & strA, const std::string & strB );
    static bool equalsIgnoreCase ( const std::string & strA, const std::string & strB );
    static bool startsWith       ( const std::string & str,  const std::string & prefix );
    static bool endsWith         ( const std::string & str,  const std::string & suffix );
    static int  indexOf          ( const std::string & str,  const std::string & match );
    static int  indexOf          ( const std::string & str,  const std::string & match, 
                                   size_t from );
    static int  lastIndexOf      ( const std::string & str,  const std::string & match );
    static int  lastIndexOf      ( const std::string & str,  const std::string & match, 
                                   size_t from );
    ...
    static void          trim          ( std::string & str, const std::string & rem );
...
#   ifdef TCANET_WIDECHAR
    ...
    static bool equals           ( const std::wstring & strA, const std::wstring & strB );
    static bool equalsIgnoreCase ( const std::wstring & strA, const std::wstring & strB );
    ...
    static int  indexOf          ( const std::wstring & str,  const std::wstring & match );
    static int  indexOf          ( const std::wstring & str,  const std::wstring & match, 
                                   size_t from );
    static int  lastIndexOf      ( const std::wstring & str,  const std::wstring & match );
    static int  lastIndexOf      ( const std::wstring & str,  const std::wstring & match, 
                                   size_t from );
