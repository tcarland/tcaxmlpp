...
class basic_zip_streambuf : public std::basic_streambuf<Elem, Tr> 
{
  ...
  public:
    ...
    unsigned long get_out_size() const       { return m_zip_stream.total_out; }
...
class basic_zip_ostreambase : virtual public std::basic_ios<Elem, Tr>
{
  ...
  public:
    ...
    unsigned long get_crc() const       { return m_buf.get_crc(); }
    
    /// returns the compressed data size
    unsigned long get_out_size() const  { return m_buf.get_out_size(); }
    ...
    public std::basic_istream<Elem,Tr>
{
  ...
  public:
    ...
    unsigned long get_gzip_crc() const	     { return m_gzip_crc; }
    
    /// return the data size in the file 
    unsigned long get_gzip_data_size() const { return m_gzip_data_size; }
