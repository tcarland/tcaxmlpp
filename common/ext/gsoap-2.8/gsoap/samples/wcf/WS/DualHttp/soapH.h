...
#define soap_write_xsd__duration(soap, data) ( soap_begin(soap), soap_serialize_xsd__duration(soap, data), soap_begin_send(soap) || soap_put_xsd__duration(soap, data, "xsd:duration", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__IncompleteSequenceBehaviorType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__IncompleteSequenceBehaviorType(soap, data), soap_begin_send(soap) || soap_put_wsrm__IncompleteSequenceBehaviorType(soap, data, "wsrm:IncompleteSequenceBehaviorType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__FaultCodes(soap, data) ( soap_begin(soap), soap_serialize_wsrm__FaultCodes(soap, data), soap_begin_send(soap) || soap_put_wsrm__FaultCodes(soap, data, "wsrm:FaultCodes", NULL) || soap_end_send(soap), soap->error )
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__Equation(struct soap*, const char*, int, const _mssadh__Equation *, const char*);
SOAP_FMAC3 _mssadh__Equation * SOAP_FMAC4 soap_in__mssadh__Equation(struct soap*, const char*, _mssadh__Equation *, const char*);

#ifndef soap_write__mssadh__Equation
#define soap_write__mssadh__Equation(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:Equation", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Equation * SOAP_FMAC4 soap_get__mssadh__Equation(struct soap*, _mssadh__Equation *, const char*, const char*);

#ifndef soap_read__mssadh__Equation
#define soap_read__mssadh__Equation(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__Equation(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__Equation * SOAP_FMAC2 soap_instantiate__mssadh__Equation(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__Equation * soap_new__mssadh__Equation(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__Equation(soap, n, NULL, NULL, NULL); }

inline _mssadh__Equation * soap_new_req__mssadh__Equation(struct soap *soap) { _mssadh__Equation *_p = soap_instantiate__mssadh__Equation(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__Equation * soap_new_set__mssadh__Equation(struct soap *soap, std::string *eqn) { _mssadh__Equation *_p = soap_instantiate__mssadh__Equation(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__Equation::eqn = eqn; } return _p; }

inline void soap_delete__mssadh__Equation(struct soap *soap, _mssadh__Equation *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__Equation(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__Result
#define SOAP_TYPE__mssadh__Result (13)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__Result(struct soap*, const char*, int, const _mssadh__Result *, const char*);
SOAP_FMAC3 _mssadh__Result * SOAP_FMAC4 soap_in__mssadh__Result(struct soap*, const char*, _mssadh__Result *, const char*);

#ifndef soap_write__mssadh__Result
#define soap_write__mssadh__Result(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:Result", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Result * SOAP_FMAC4 soap_get__mssadh__Result(struct soap*, _mssadh__Result *, const char*, const char*);

#ifndef soap_read__mssadh__Result
#define soap_read__mssadh__Result(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__Result(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__Result * SOAP_FMAC2 soap_instantiate__mssadh__Result(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__Result * soap_new__mssadh__Result(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__Result(soap, n, NULL, NULL, NULL); }

inline _mssadh__Result * soap_new_req__mssadh__Result(struct soap *soap) { _mssadh__Result *_p = soap_instantiate__mssadh__Result(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__Result * soap_new_set__mssadh__Result(struct soap *soap, double *result) { _mssadh__Result *_p = soap_instantiate__mssadh__Result(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__Result::result = result; } return _p; }

inline void soap_delete__mssadh__Result(struct soap *soap, _mssadh__Result *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__Result(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__DivideBy
#define SOAP_TYPE__mssadh__DivideBy (12)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__DivideBy(struct soap*, const char*, int, const _mssadh__DivideBy *, const char*);
SOAP_FMAC3 _mssadh__DivideBy * SOAP_FMAC4 soap_in__mssadh__DivideBy(struct soap*, const char*, _mssadh__DivideBy *, const char*);

#ifndef soap_write__mssadh__DivideBy
#define soap_write__mssadh__DivideBy(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:DivideBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__DivideBy * SOAP_FMAC4 soap_get__mssadh__DivideBy(struct soap*, _mssadh__DivideBy *, const char*, const char*);

#ifndef soap_read__mssadh__DivideBy
#define soap_read__mssadh__DivideBy(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__DivideBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__DivideBy * SOAP_FMAC2 soap_instantiate__mssadh__DivideBy(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__DivideBy * soap_new__mssadh__DivideBy(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__DivideBy(soap, n, NULL, NULL, NULL); }

inline _mssadh__DivideBy * soap_new_req__mssadh__DivideBy(struct soap *soap) { _mssadh__DivideBy *_p = soap_instantiate__mssadh__DivideBy(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__DivideBy * soap_new_set__mssadh__DivideBy(struct soap *soap, double *n) { _mssadh__DivideBy *_p = soap_instantiate__mssadh__DivideBy(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__DivideBy::n = n; } return _p; }

inline void soap_delete__mssadh__DivideBy(struct soap *soap, _mssadh__DivideBy *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__DivideBy(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__MultiplyBy
#define SOAP_TYPE__mssadh__MultiplyBy (11)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__MultiplyBy(struct soap*, const char*, int, const _mssadh__MultiplyBy *, const char*);
SOAP_FMAC3 _mssadh__MultiplyBy * SOAP_FMAC4 soap_in__mssadh__MultiplyBy(struct soap*, const char*, _mssadh__MultiplyBy *, const char*);

#ifndef soap_write__mssadh__MultiplyBy
#define soap_write__mssadh__MultiplyBy(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:MultiplyBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__MultiplyBy * SOAP_FMAC4 soap_get__mssadh__MultiplyBy(struct soap*, _mssadh__MultiplyBy *, const char*, const char*);

#ifndef soap_read__mssadh__MultiplyBy
#define soap_read__mssadh__MultiplyBy(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__MultiplyBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__MultiplyBy * SOAP_FMAC2 soap_instantiate__mssadh__MultiplyBy(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__MultiplyBy * soap_new__mssadh__MultiplyBy(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__MultiplyBy(soap, n, NULL, NULL, NULL); }

inline _mssadh__MultiplyBy * soap_new_req__mssadh__MultiplyBy(struct soap *soap) { _mssadh__MultiplyBy *_p = soap_instantiate__mssadh__MultiplyBy(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__MultiplyBy * soap_new_set__mssadh__MultiplyBy(struct soap *soap, double *n) { _mssadh__MultiplyBy *_p = soap_instantiate__mssadh__MultiplyBy(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__MultiplyBy::n = n; } return _p; }

inline void soap_delete__mssadh__MultiplyBy(struct soap *soap, _mssadh__MultiplyBy *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__MultiplyBy(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__SubtractFrom
#define SOAP_TYPE__mssadh__SubtractFrom (10)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__SubtractFrom(struct soap*, const char*, int, const _mssadh__SubtractFrom *, const char*);
SOAP_FMAC3 _mssadh__SubtractFrom * SOAP_FMAC4 soap_in__mssadh__SubtractFrom(struct soap*, const char*, _mssadh__SubtractFrom *, const char*);

#ifndef soap_write__mssadh__SubtractFrom
#define soap_write__mssadh__SubtractFrom(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:SubtractFrom", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__SubtractFrom * SOAP_FMAC4 soap_get__mssadh__SubtractFrom(struct soap*, _mssadh__SubtractFrom *, const char*, const char*);

#ifndef soap_read__mssadh__SubtractFrom
#define soap_read__mssadh__SubtractFrom(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__SubtractFrom(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__SubtractFrom * SOAP_FMAC2 soap_instantiate__mssadh__SubtractFrom(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__SubtractFrom * soap_new__mssadh__SubtractFrom(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__SubtractFrom(soap, n, NULL, NULL, NULL); }

inline _mssadh__SubtractFrom * soap_new_req__mssadh__SubtractFrom(struct soap *soap) { _mssadh__SubtractFrom *_p = soap_instantiate__mssadh__SubtractFrom(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__SubtractFrom * soap_new_set__mssadh__SubtractFrom(struct soap *soap, double *n) { _mssadh__SubtractFrom *_p = soap_instantiate__mssadh__SubtractFrom(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__SubtractFrom::n = n; } return _p; }

inline void soap_delete__mssadh__SubtractFrom(struct soap *soap, _mssadh__SubtractFrom *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__SubtractFrom(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__AddTo
#define SOAP_TYPE__mssadh__AddTo (9)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__AddTo(struct soap*, const char*, int, const _mssadh__AddTo *, const char*);
SOAP_FMAC3 _mssadh__AddTo * SOAP_FMAC4 soap_in__mssadh__AddTo(struct soap*, const char*, _mssadh__AddTo *, const char*);

#ifndef soap_write__mssadh__AddTo
#define soap_write__mssadh__AddTo(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:AddTo", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__AddTo * SOAP_FMAC4 soap_get__mssadh__AddTo(struct soap*, _mssadh__AddTo *, const char*, const char*);

#ifndef soap_read__mssadh__AddTo
#define soap_read__mssadh__AddTo(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__AddTo(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__AddTo * SOAP_FMAC2 soap_instantiate__mssadh__AddTo(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__AddTo * soap_new__mssadh__AddTo(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__AddTo(soap, n, NULL, NULL, NULL); }

inline _mssadh__AddTo * soap_new_req__mssadh__AddTo(struct soap *soap) { _mssadh__AddTo *_p = soap_instantiate__mssadh__AddTo(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__AddTo * soap_new_set__mssadh__AddTo(struct soap *soap, double *n) { _mssadh__AddTo *_p = soap_instantiate__mssadh__AddTo(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_mssadh__AddTo::n = n; } return _p; }

inline void soap_delete__mssadh__AddTo(struct soap *soap, _mssadh__AddTo *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__AddTo(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__mssadh__Clear
#define SOAP_TYPE__mssadh__Clear (8)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__mssadh__Clear(struct soap*, const char*, int, const _mssadh__Clear *, const char*);
SOAP_FMAC3 _mssadh__Clear * SOAP_FMAC4 soap_in__mssadh__Clear(struct soap*, const char*, _mssadh__Clear *, const char*);

#ifndef soap_write__mssadh__Clear
#define soap_write__mssadh__Clear(soap, data) ( soap_begin(soap), (data)->soap_serialize(soap), soap_begin_send(soap) || (data)->soap_put(soap, "mssadh:Clear", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Clear * SOAP_FMAC4 soap_get__mssadh__Clear(struct soap*, _mssadh__Clear *, const char*, const char*);

#ifndef soap_read__mssadh__Clear
#define soap_read__mssadh__Clear(soap, data) ( soap_begin_recv(soap) || !soap_get__mssadh__Clear(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 _mssadh__Clear * SOAP_FMAC2 soap_instantiate__mssadh__Clear(struct soap*, int, const char*, const char*, size_t*);

inline _mssadh__Clear * soap_new__mssadh__Clear(struct soap *soap, int n = -1) { return soap_instantiate__mssadh__Clear(soap, n, NULL, NULL, NULL); }

inline _mssadh__Clear * soap_new_req__mssadh__Clear(struct soap *soap) { _mssadh__Clear *_p = soap_instantiate__mssadh__Clear(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _mssadh__Clear * soap_new_set__mssadh__Clear(struct soap *soap) { _mssadh__Clear *_p = soap_instantiate__mssadh__Clear(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline void soap_delete__mssadh__Clear(struct soap *soap, _mssadh__Clear *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__mssadh__Clear(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#define soap_write___wsrm__LastMessage(soap, data) ( soap_begin(soap), soap_serialize___wsrm__LastMessage(soap, data), soap_begin_send(soap) || soap_put___wsrm__LastMessage(soap, data, "-wsrm:LastMessage", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__AckRequested(soap, data) ( soap_begin(soap), soap_serialize___wsrm__AckRequested(soap, data), soap_begin_send(soap) || soap_put___wsrm__AckRequested(soap, data, "-wsrm:AckRequested", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__SequenceAcknowledgement(soap, data) ( soap_begin(soap), soap_serialize___wsrm__SequenceAcknowledgement(soap, data), soap_begin_send(soap) || soap_put___wsrm__SequenceAcknowledgement(soap, data, "-wsrm:SequenceAcknowledgement", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__TerminateSequenceResponse(soap, data) ( soap_begin(soap), soap_serialize___wsrm__TerminateSequenceResponse(soap, data), soap_begin_send(soap) || soap_put___wsrm__TerminateSequenceResponse(soap, data, "-wsrm:TerminateSequenceResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__CloseSequenceResponse(soap, data) ( soap_begin(soap), soap_serialize___wsrm__CloseSequenceResponse(soap, data), soap_begin_send(soap) || soap_put___wsrm__CloseSequenceResponse(soap, data, "-wsrm:CloseSequenceResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__CreateSequenceResponse(soap, data) ( soap_begin(soap), soap_serialize___wsrm__CreateSequenceResponse(soap, data), soap_begin_send(soap) || soap_put___wsrm__CreateSequenceResponse(soap, data, "-wsrm:CreateSequenceResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__TerminateSequence(soap, data) ( soap_begin(soap), soap_serialize___wsrm__TerminateSequence(soap, data), soap_begin_send(soap) || soap_put___wsrm__TerminateSequence(soap, data, "-wsrm:TerminateSequence", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__CloseSequence(soap, data) ( soap_begin(soap), soap_serialize___wsrm__CloseSequence(soap, data), soap_begin_send(soap) || soap_put___wsrm__CloseSequence(soap, data, "-wsrm:CloseSequence", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write___wsrm__CreateSequence(soap, data) ( soap_begin(soap), soap_serialize___wsrm__CreateSequence(soap, data), soap_begin_send(soap) || soap_put___wsrm__CreateSequence(soap, data, "-wsrm:CreateSequence", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__SequenceAcknowledgement_None(soap, data) ( soap_begin(soap), soap_serialize__wsrm__SequenceAcknowledgement_None(soap, data), soap_begin_send(soap) || soap_put__wsrm__SequenceAcknowledgement_None(soap, data, "wsrm:SequenceAcknowledgement-None", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data) ( soap_begin(soap), soap_serialize__wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data), soap_begin_send(soap) || soap_put__wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data, "wsrm:SequenceAcknowledgement-AcknowledgementRange", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__SequenceAcknowledgement_Final(soap, data) ( soap_begin(soap), soap_serialize__wsrm__SequenceAcknowledgement_Final(soap, data), soap_begin_send(soap) || soap_put__wsrm__SequenceAcknowledgement_Final(soap, data, "wsrm:SequenceAcknowledgement-Final", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__UsesSequenceSSL(soap, data) ( soap_begin(soap), soap_serialize__wsrm__UsesSequenceSSL(soap, data), soap_begin_send(soap) || soap_put__wsrm__UsesSequenceSSL(soap, data, "wsrm:UsesSequenceSSL", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__UsesSequenceSTR(soap, data) ( soap_begin(soap), soap_serialize__wsrm__UsesSequenceSTR(soap, data), soap_begin_send(soap) || soap_put__wsrm__UsesSequenceSTR(soap, data, "wsrm:UsesSequenceSTR", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__wsrm__SequenceAcknowledgement(soap, data) ( soap_begin(soap), soap_serialize__wsrm__SequenceAcknowledgement(soap, data), soap_begin_send(soap) || soap_put__wsrm__SequenceAcknowledgement(soap, data, "wsrm:SequenceAcknowledgement", NULL) || soap_end_send(soap), soap->error )
#endif
...
inline struct _wsrm__SequenceAcknowledgement * soap_new_set__wsrm__SequenceAcknowledgement(struct soap *soap, char *Identifier, int __sizeNack, ULONG64 *Nack, struct _wsrm__SequenceAcknowledgement_Final *Final, int __sizeAcknowledgementRange, struct _wsrm__SequenceAcknowledgement_AcknowledgementRange *AcknowledgementRange, struct _wsrm__SequenceAcknowledgement_None *None, char *__any) { struct _wsrm__SequenceAcknowledgement *_p = soap_instantiate__wsrm__SequenceAcknowledgement(soap, -1, NULL, NULL, NULL); if (_p) { soap_default__wsrm__SequenceAcknowledgement(soap, _p); _p->Identifier = Identifier; _p->__sizeNack = __sizeNack; _p->Nack = Nack; _p->Final = Final; _p->__sizeAcknowledgementRange = __sizeAcknowledgementRange; _p->AcknowledgementRange = AcknowledgementRange; _p->None = None; _p->__any = __any; } return _p; }
...
#define soap_write_wsrm__AcceptType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__AcceptType(soap, data), soap_begin_send(soap) || soap_put_wsrm__AcceptType(soap, data, "wsrm:AcceptType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__OfferType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__OfferType(soap, data), soap_begin_send(soap) || soap_put_wsrm__OfferType(soap, data, "wsrm:OfferType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__TerminateSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__TerminateSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_wsrm__TerminateSequenceResponseType(soap, data, "wsrm:TerminateSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__TerminateSequenceType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__TerminateSequenceType(soap, data), soap_begin_send(soap) || soap_put_wsrm__TerminateSequenceType(soap, data, "wsrm:TerminateSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__CloseSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__CloseSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_wsrm__CloseSequenceResponseType(soap, data, "wsrm:CloseSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__CloseSequenceType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__CloseSequenceType(soap, data), soap_begin_send(soap) || soap_put_wsrm__CloseSequenceType(soap, data, "wsrm:CloseSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
inline struct wsrm__CloseSequenceType * soap_new_set_wsrm__CloseSequenceType(struct soap *soap, char *Identifier, ULONG64 *LastMsgNumber) { struct wsrm__CloseSequenceType *_p = soap_instantiate_wsrm__CloseSequenceType(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_wsrm__CloseSequenceType(soap, _p); _p->Identifier = Identifier; _p->LastMsgNumber = LastMsgNumber; } return _p; }
...
#define soap_write_wsrm__CreateSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__CreateSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_wsrm__CreateSequenceResponseType(soap, data, "wsrm:CreateSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__CreateSequenceType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__CreateSequenceType(soap, data), soap_begin_send(soap) || soap_put_wsrm__CreateSequenceType(soap, data, "wsrm:CreateSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__SequenceFaultType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__SequenceFaultType(soap, data), soap_begin_send(soap) || soap_put_wsrm__SequenceFaultType(soap, data, "wsrm:SequenceFaultType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__AckRequestedType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__AckRequestedType(soap, data), soap_begin_send(soap) || soap_put_wsrm__AckRequestedType(soap, data, "wsrm:AckRequestedType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_wsrm__SequenceType(soap, data) ( soap_begin(soap), soap_serialize_wsrm__SequenceType(soap, data), soap_begin_send(soap) || soap_put_wsrm__SequenceType(soap, data, "wsrm:SequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__Equation(struct soap*, struct __tempuri__Equation *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__Equation(struct soap*, const struct __tempuri__Equation *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__Equation(struct soap*, const char*, int, const struct __tempuri__Equation *, const char*);
SOAP_FMAC3 struct __tempuri__Equation * SOAP_FMAC4 soap_in___tempuri__Equation(struct soap*, const char*, struct __tempuri__Equation *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__Equation(struct soap*, const struct __tempuri__Equation *, const char*, const char*);

#ifndef soap_write___tempuri__Equation
#define soap_write___tempuri__Equation(soap, data) ( soap_begin(soap), soap_serialize___tempuri__Equation(soap, data), soap_begin_send(soap) || soap_put___tempuri__Equation(soap, data, "-tempuri:Equation", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__Equation * SOAP_FMAC4 soap_get___tempuri__Equation(struct soap*, struct __tempuri__Equation *, const char*, const char*);

#ifndef soap_read___tempuri__Equation
#define soap_read___tempuri__Equation(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__Equation(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__Equation * SOAP_FMAC2 soap_instantiate___tempuri__Equation(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__Equation * soap_new___tempuri__Equation(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__Equation(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__Equation * soap_new_req___tempuri__Equation(struct soap *soap) { struct __tempuri__Equation *_p = soap_instantiate___tempuri__Equation(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Equation(soap, _p); } return _p; }

inline struct __tempuri__Equation * soap_new_set___tempuri__Equation(struct soap *soap, _mssadh__Equation *mssadh__Equation) { struct __tempuri__Equation *_p = soap_instantiate___tempuri__Equation(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Equation(soap, _p); _p->mssadh__Equation = mssadh__Equation; } return _p; }

inline void soap_delete___tempuri__Equation(struct soap *soap, struct __tempuri__Equation *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__Equation(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__Result
#define SOAP_TYPE___tempuri__Result (38)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__Result(struct soap*, struct __tempuri__Result *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__Result(struct soap*, const struct __tempuri__Result *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__Result(struct soap*, const char*, int, const struct __tempuri__Result *, const char*);
SOAP_FMAC3 struct __tempuri__Result * SOAP_FMAC4 soap_in___tempuri__Result(struct soap*, const char*, struct __tempuri__Result *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__Result(struct soap*, const struct __tempuri__Result *, const char*, const char*);

#ifndef soap_write___tempuri__Result
#define soap_write___tempuri__Result(soap, data) ( soap_begin(soap), soap_serialize___tempuri__Result(soap, data), soap_begin_send(soap) || soap_put___tempuri__Result(soap, data, "-tempuri:Result", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__Result * SOAP_FMAC4 soap_get___tempuri__Result(struct soap*, struct __tempuri__Result *, const char*, const char*);

#ifndef soap_read___tempuri__Result
#define soap_read___tempuri__Result(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__Result(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__Result * SOAP_FMAC2 soap_instantiate___tempuri__Result(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__Result * soap_new___tempuri__Result(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__Result(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__Result * soap_new_req___tempuri__Result(struct soap *soap) { struct __tempuri__Result *_p = soap_instantiate___tempuri__Result(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Result(soap, _p); } return _p; }

inline struct __tempuri__Result * soap_new_set___tempuri__Result(struct soap *soap, _mssadh__Result *mssadh__Result) { struct __tempuri__Result *_p = soap_instantiate___tempuri__Result(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Result(soap, _p); _p->mssadh__Result = mssadh__Result; } return _p; }

inline void soap_delete___tempuri__Result(struct soap *soap, struct __tempuri__Result *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__Result(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__DivideBy
#define SOAP_TYPE___tempuri__DivideBy (35)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__DivideBy(struct soap*, struct __tempuri__DivideBy *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__DivideBy(struct soap*, const struct __tempuri__DivideBy *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__DivideBy(struct soap*, const char*, int, const struct __tempuri__DivideBy *, const char*);
SOAP_FMAC3 struct __tempuri__DivideBy * SOAP_FMAC4 soap_in___tempuri__DivideBy(struct soap*, const char*, struct __tempuri__DivideBy *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__DivideBy(struct soap*, const struct __tempuri__DivideBy *, const char*, const char*);

#ifndef soap_write___tempuri__DivideBy
#define soap_write___tempuri__DivideBy(soap, data) ( soap_begin(soap), soap_serialize___tempuri__DivideBy(soap, data), soap_begin_send(soap) || soap_put___tempuri__DivideBy(soap, data, "-tempuri:DivideBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__DivideBy * SOAP_FMAC4 soap_get___tempuri__DivideBy(struct soap*, struct __tempuri__DivideBy *, const char*, const char*);

#ifndef soap_read___tempuri__DivideBy
#define soap_read___tempuri__DivideBy(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__DivideBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__DivideBy * SOAP_FMAC2 soap_instantiate___tempuri__DivideBy(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__DivideBy * soap_new___tempuri__DivideBy(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__DivideBy(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__DivideBy * soap_new_req___tempuri__DivideBy(struct soap *soap) { struct __tempuri__DivideBy *_p = soap_instantiate___tempuri__DivideBy(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__DivideBy(soap, _p); } return _p; }

inline struct __tempuri__DivideBy * soap_new_set___tempuri__DivideBy(struct soap *soap, _mssadh__DivideBy *mssadh__DivideBy) { struct __tempuri__DivideBy *_p = soap_instantiate___tempuri__DivideBy(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__DivideBy(soap, _p); _p->mssadh__DivideBy = mssadh__DivideBy; } return _p; }

inline void soap_delete___tempuri__DivideBy(struct soap *soap, struct __tempuri__DivideBy *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__DivideBy(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__MultiplyBy
#define SOAP_TYPE___tempuri__MultiplyBy (32)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__MultiplyBy(struct soap*, struct __tempuri__MultiplyBy *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__MultiplyBy(struct soap*, const struct __tempuri__MultiplyBy *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__MultiplyBy(struct soap*, const char*, int, const struct __tempuri__MultiplyBy *, const char*);
SOAP_FMAC3 struct __tempuri__MultiplyBy * SOAP_FMAC4 soap_in___tempuri__MultiplyBy(struct soap*, const char*, struct __tempuri__MultiplyBy *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__MultiplyBy(struct soap*, const struct __tempuri__MultiplyBy *, const char*, const char*);

#ifndef soap_write___tempuri__MultiplyBy
#define soap_write___tempuri__MultiplyBy(soap, data) ( soap_begin(soap), soap_serialize___tempuri__MultiplyBy(soap, data), soap_begin_send(soap) || soap_put___tempuri__MultiplyBy(soap, data, "-tempuri:MultiplyBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__MultiplyBy * SOAP_FMAC4 soap_get___tempuri__MultiplyBy(struct soap*, struct __tempuri__MultiplyBy *, const char*, const char*);

#ifndef soap_read___tempuri__MultiplyBy
#define soap_read___tempuri__MultiplyBy(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__MultiplyBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__MultiplyBy * SOAP_FMAC2 soap_instantiate___tempuri__MultiplyBy(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__MultiplyBy * soap_new___tempuri__MultiplyBy(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__MultiplyBy(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__MultiplyBy * soap_new_req___tempuri__MultiplyBy(struct soap *soap) { struct __tempuri__MultiplyBy *_p = soap_instantiate___tempuri__MultiplyBy(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__MultiplyBy(soap, _p); } return _p; }

inline struct __tempuri__MultiplyBy * soap_new_set___tempuri__MultiplyBy(struct soap *soap, _mssadh__MultiplyBy *mssadh__MultiplyBy) { struct __tempuri__MultiplyBy *_p = soap_instantiate___tempuri__MultiplyBy(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__MultiplyBy(soap, _p); _p->mssadh__MultiplyBy = mssadh__MultiplyBy; } return _p; }

inline void soap_delete___tempuri__MultiplyBy(struct soap *soap, struct __tempuri__MultiplyBy *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__MultiplyBy(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__SubtractFrom
#define SOAP_TYPE___tempuri__SubtractFrom (29)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__SubtractFrom(struct soap*, struct __tempuri__SubtractFrom *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__SubtractFrom(struct soap*, const struct __tempuri__SubtractFrom *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__SubtractFrom(struct soap*, const char*, int, const struct __tempuri__SubtractFrom *, const char*);
SOAP_FMAC3 struct __tempuri__SubtractFrom * SOAP_FMAC4 soap_in___tempuri__SubtractFrom(struct soap*, const char*, struct __tempuri__SubtractFrom *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__SubtractFrom(struct soap*, const struct __tempuri__SubtractFrom *, const char*, const char*);

#ifndef soap_write___tempuri__SubtractFrom
#define soap_write___tempuri__SubtractFrom(soap, data) ( soap_begin(soap), soap_serialize___tempuri__SubtractFrom(soap, data), soap_begin_send(soap) || soap_put___tempuri__SubtractFrom(soap, data, "-tempuri:SubtractFrom", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__SubtractFrom * SOAP_FMAC4 soap_get___tempuri__SubtractFrom(struct soap*, struct __tempuri__SubtractFrom *, const char*, const char*);

#ifndef soap_read___tempuri__SubtractFrom
#define soap_read___tempuri__SubtractFrom(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__SubtractFrom(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__SubtractFrom * SOAP_FMAC2 soap_instantiate___tempuri__SubtractFrom(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__SubtractFrom * soap_new___tempuri__SubtractFrom(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__SubtractFrom(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__SubtractFrom * soap_new_req___tempuri__SubtractFrom(struct soap *soap) { struct __tempuri__SubtractFrom *_p = soap_instantiate___tempuri__SubtractFrom(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__SubtractFrom(soap, _p); } return _p; }

inline struct __tempuri__SubtractFrom * soap_new_set___tempuri__SubtractFrom(struct soap *soap, _mssadh__SubtractFrom *mssadh__SubtractFrom) { struct __tempuri__SubtractFrom *_p = soap_instantiate___tempuri__SubtractFrom(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__SubtractFrom(soap, _p); _p->mssadh__SubtractFrom = mssadh__SubtractFrom; } return _p; }

inline void soap_delete___tempuri__SubtractFrom(struct soap *soap, struct __tempuri__SubtractFrom *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__SubtractFrom(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__AddTo
#define SOAP_TYPE___tempuri__AddTo (26)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__AddTo(struct soap*, struct __tempuri__AddTo *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__AddTo(struct soap*, const struct __tempuri__AddTo *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__AddTo(struct soap*, const char*, int, const struct __tempuri__AddTo *, const char*);
SOAP_FMAC3 struct __tempuri__AddTo * SOAP_FMAC4 soap_in___tempuri__AddTo(struct soap*, const char*, struct __tempuri__AddTo *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__AddTo(struct soap*, const struct __tempuri__AddTo *, const char*, const char*);

#ifndef soap_write___tempuri__AddTo
#define soap_write___tempuri__AddTo(soap, data) ( soap_begin(soap), soap_serialize___tempuri__AddTo(soap, data), soap_begin_send(soap) || soap_put___tempuri__AddTo(soap, data, "-tempuri:AddTo", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__AddTo * SOAP_FMAC4 soap_get___tempuri__AddTo(struct soap*, struct __tempuri__AddTo *, const char*, const char*);

#ifndef soap_read___tempuri__AddTo
#define soap_read___tempuri__AddTo(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__AddTo(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__AddTo * SOAP_FMAC2 soap_instantiate___tempuri__AddTo(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__AddTo * soap_new___tempuri__AddTo(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__AddTo(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__AddTo * soap_new_req___tempuri__AddTo(struct soap *soap) { struct __tempuri__AddTo *_p = soap_instantiate___tempuri__AddTo(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__AddTo(soap, _p); } return _p; }

inline struct __tempuri__AddTo * soap_new_set___tempuri__AddTo(struct soap *soap, _mssadh__AddTo *mssadh__AddTo) { struct __tempuri__AddTo *_p = soap_instantiate___tempuri__AddTo(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__AddTo(soap, _p); _p->mssadh__AddTo = mssadh__AddTo; } return _p; }

inline void soap_delete___tempuri__AddTo(struct soap *soap, struct __tempuri__AddTo *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__AddTo(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___tempuri__Clear
#define SOAP_TYPE___tempuri__Clear (23)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__Clear(struct soap*, struct __tempuri__Clear *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__Clear(struct soap*, const struct __tempuri__Clear *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__Clear(struct soap*, const char*, int, const struct __tempuri__Clear *, const char*);
SOAP_FMAC3 struct __tempuri__Clear * SOAP_FMAC4 soap_in___tempuri__Clear(struct soap*, const char*, struct __tempuri__Clear *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__Clear(struct soap*, const struct __tempuri__Clear *, const char*, const char*);

#ifndef soap_write___tempuri__Clear
#define soap_write___tempuri__Clear(soap, data) ( soap_begin(soap), soap_serialize___tempuri__Clear(soap, data), soap_begin_send(soap) || soap_put___tempuri__Clear(soap, data, "-tempuri:Clear", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 struct __tempuri__Clear * SOAP_FMAC4 soap_get___tempuri__Clear(struct soap*, struct __tempuri__Clear *, const char*, const char*);

#ifndef soap_read___tempuri__Clear
#define soap_read___tempuri__Clear(soap, data) ( soap_begin_recv(soap) || !soap_get___tempuri__Clear(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif

SOAP_FMAC1 struct __tempuri__Clear * SOAP_FMAC2 soap_instantiate___tempuri__Clear(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__Clear * soap_new___tempuri__Clear(struct soap *soap, int n = -1) { return soap_instantiate___tempuri__Clear(soap, n, NULL, NULL, NULL); }

inline struct __tempuri__Clear * soap_new_req___tempuri__Clear(struct soap *soap) { struct __tempuri__Clear *_p = soap_instantiate___tempuri__Clear(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Clear(soap, _p); } return _p; }

inline struct __tempuri__Clear * soap_new_set___tempuri__Clear(struct soap *soap, _mssadh__Clear *mssadh__Clear) { struct __tempuri__Clear *_p = soap_instantiate___tempuri__Clear(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___tempuri__Clear(soap, _p); _p->mssadh__Clear = mssadh__Clear; } return _p; }

inline void soap_delete___tempuri__Clear(struct soap *soap, struct __tempuri__Clear *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___tempuri__Clear(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_PointerTowsrm__TerminateSequenceResponseType
#define SOAP_TYPE_PointerTowsrm__TerminateSequenceResponseType (132)
#endif
...
#define soap_write_PointerTowsrm__TerminateSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__TerminateSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__TerminateSequenceResponseType(soap, data, "wsrm:TerminateSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__TerminateSequenceType (131)
#endif
...
#define soap_write_PointerTowsrm__TerminateSequenceType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__TerminateSequenceType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__TerminateSequenceType(soap, data, "wsrm:TerminateSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__CloseSequenceResponseType (128)
#endif
...
#define soap_write_PointerTowsrm__CloseSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__CloseSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__CloseSequenceResponseType(soap, data, "wsrm:CloseSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__CloseSequenceType (127)
#endif
...
#define soap_write_PointerTowsrm__CloseSequenceType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__CloseSequenceType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__CloseSequenceType(soap, data, "wsrm:CloseSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__CreateSequenceResponseType (124)
#endif
...
#define soap_write_PointerTowsrm__CreateSequenceResponseType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__CreateSequenceResponseType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__CreateSequenceResponseType(soap, data, "wsrm:CreateSequenceResponseType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__CreateSequenceType (123)
#endif
...
#define soap_write_PointerTowsrm__CreateSequenceType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__CreateSequenceType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__CreateSequenceType(soap, data, "wsrm:CreateSequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__SequenceFaultType (122)
#endif
...
#define soap_write_PointerTowsrm__SequenceFaultType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__SequenceFaultType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__SequenceFaultType(soap, data, "wsrm:SequenceFaultType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTo_wsrm__SequenceAcknowledgement (121)
#endif
...
#define soap_write_PointerTo_wsrm__SequenceAcknowledgement(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_wsrm__SequenceAcknowledgement(soap, data), soap_begin_send(soap) || soap_put_PointerTo_wsrm__SequenceAcknowledgement(soap, data, "wsrm:SequenceAcknowledgement", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__AckRequestedType (120)
#endif
...
#define soap_write_PointerTowsrm__AckRequestedType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__AckRequestedType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__AckRequestedType(soap, data, "wsrm:AckRequestedType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__SequenceType (119)
#endif
...
#define soap_write_PointerTowsrm__SequenceType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__SequenceType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__SequenceType(soap, data, "wsrm:SequenceType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTo_wsrm__SequenceAcknowledgement_None (118)
#endif
...
#define soap_write_PointerTo_wsrm__SequenceAcknowledgement_None(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_wsrm__SequenceAcknowledgement_None(soap, data), soap_begin_send(soap) || soap_put_PointerTo_wsrm__SequenceAcknowledgement_None(soap, data, "wsrm:SequenceAcknowledgement-None", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTo_wsrm__SequenceAcknowledgement_AcknowledgementRange (116)
#endif
...
#define soap_write_PointerTo_wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data), soap_begin_send(soap) || soap_put_PointerTo_wsrm__SequenceAcknowledgement_AcknowledgementRange(soap, data, "wsrm:SequenceAcknowledgement-AcknowledgementRange", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTo_wsrm__SequenceAcknowledgement_Final (114)
#endif
...
#define soap_write_PointerTo_wsrm__SequenceAcknowledgement_Final(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_wsrm__SequenceAcknowledgement_Final(soap, data), soap_begin_send(soap) || soap_put_PointerTo_wsrm__SequenceAcknowledgement_Final(soap, data, "wsrm:SequenceAcknowledgement-Final", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTounsignedLONG64 (112)
#endif
...
#define SOAP_TYPE_PointerTowsrm__AcceptType (111)
#endif
...
#define soap_write_PointerTowsrm__AcceptType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__AcceptType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__AcceptType(soap, data, "wsrm:AcceptType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__IncompleteSequenceBehaviorType (110)
#endif
...
#define soap_write_PointerTowsrm__IncompleteSequenceBehaviorType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__IncompleteSequenceBehaviorType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__IncompleteSequenceBehaviorType(soap, data, "wsrm:IncompleteSequenceBehaviorType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTowsrm__OfferType (109)
#endif
...
#define soap_write_PointerTowsrm__OfferType(soap, data) ( soap_begin(soap), soap_serialize_PointerTowsrm__OfferType(soap, data), soap_begin_send(soap) || soap_put_PointerTowsrm__OfferType(soap, data, "wsrm:OfferType", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerToxsd__duration (108)
#endif
...
#define soap_write_PointerToxsd__duration(soap, data) ( soap_begin(soap), soap_serialize_PointerToxsd__duration(soap, data), soap_begin_send(soap) || soap_put_PointerToxsd__duration(soap, data, "xsd:duration", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define SOAP_TYPE_PointerTo_wsrm__UsesSequenceSSL (107)
#endif
...
#define soap_write_PointerTo_wsrm__UsesSequenceSSL(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_wsrm__UsesSequenceSSL(soap, data), soap_begin_send(soap) || soap_put_PointerTo_wsrm__UsesSequenceSSL(soap, data, "wsrm:UsesSequenceSSL", NULL) || soap_end_send(soap), soap->error )
#endif
...
#ifndef SOAP_TYPE_PointerTo_mssadh__Equation
#define SOAP_TYPE_PointerTo_mssadh__Equation (39)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__Equation(struct soap*, _mssadh__Equation *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__Equation(struct soap*, const char *, int, _mssadh__Equation *const*, const char *);
SOAP_FMAC3 _mssadh__Equation ** SOAP_FMAC4 soap_in_PointerTo_mssadh__Equation(struct soap*, const char*, _mssadh__Equation **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__Equation(struct soap*, _mssadh__Equation *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__Equation
#define soap_write_PointerTo_mssadh__Equation(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__Equation(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__Equation(soap, data, "mssadh:Equation", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Equation ** SOAP_FMAC4 soap_get_PointerTo_mssadh__Equation(struct soap*, _mssadh__Equation **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__Equation
#define soap_read_PointerTo_mssadh__Equation(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__Equation(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__Result
#define SOAP_TYPE_PointerTo_mssadh__Result (36)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__Result(struct soap*, _mssadh__Result *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__Result(struct soap*, const char *, int, _mssadh__Result *const*, const char *);
SOAP_FMAC3 _mssadh__Result ** SOAP_FMAC4 soap_in_PointerTo_mssadh__Result(struct soap*, const char*, _mssadh__Result **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__Result(struct soap*, _mssadh__Result *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__Result
#define soap_write_PointerTo_mssadh__Result(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__Result(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__Result(soap, data, "mssadh:Result", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Result ** SOAP_FMAC4 soap_get_PointerTo_mssadh__Result(struct soap*, _mssadh__Result **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__Result
#define soap_read_PointerTo_mssadh__Result(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__Result(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__DivideBy
#define SOAP_TYPE_PointerTo_mssadh__DivideBy (33)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__DivideBy(struct soap*, _mssadh__DivideBy *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__DivideBy(struct soap*, const char *, int, _mssadh__DivideBy *const*, const char *);
SOAP_FMAC3 _mssadh__DivideBy ** SOAP_FMAC4 soap_in_PointerTo_mssadh__DivideBy(struct soap*, const char*, _mssadh__DivideBy **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__DivideBy(struct soap*, _mssadh__DivideBy *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__DivideBy
#define soap_write_PointerTo_mssadh__DivideBy(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__DivideBy(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__DivideBy(soap, data, "mssadh:DivideBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__DivideBy ** SOAP_FMAC4 soap_get_PointerTo_mssadh__DivideBy(struct soap*, _mssadh__DivideBy **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__DivideBy
#define soap_read_PointerTo_mssadh__DivideBy(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__DivideBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__MultiplyBy
#define SOAP_TYPE_PointerTo_mssadh__MultiplyBy (30)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__MultiplyBy(struct soap*, _mssadh__MultiplyBy *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__MultiplyBy(struct soap*, const char *, int, _mssadh__MultiplyBy *const*, const char *);
SOAP_FMAC3 _mssadh__MultiplyBy ** SOAP_FMAC4 soap_in_PointerTo_mssadh__MultiplyBy(struct soap*, const char*, _mssadh__MultiplyBy **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__MultiplyBy(struct soap*, _mssadh__MultiplyBy *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__MultiplyBy
#define soap_write_PointerTo_mssadh__MultiplyBy(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__MultiplyBy(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__MultiplyBy(soap, data, "mssadh:MultiplyBy", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__MultiplyBy ** SOAP_FMAC4 soap_get_PointerTo_mssadh__MultiplyBy(struct soap*, _mssadh__MultiplyBy **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__MultiplyBy
#define soap_read_PointerTo_mssadh__MultiplyBy(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__MultiplyBy(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__SubtractFrom
#define SOAP_TYPE_PointerTo_mssadh__SubtractFrom (27)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__SubtractFrom(struct soap*, _mssadh__SubtractFrom *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__SubtractFrom(struct soap*, const char *, int, _mssadh__SubtractFrom *const*, const char *);
SOAP_FMAC3 _mssadh__SubtractFrom ** SOAP_FMAC4 soap_in_PointerTo_mssadh__SubtractFrom(struct soap*, const char*, _mssadh__SubtractFrom **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__SubtractFrom(struct soap*, _mssadh__SubtractFrom *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__SubtractFrom
#define soap_write_PointerTo_mssadh__SubtractFrom(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__SubtractFrom(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__SubtractFrom(soap, data, "mssadh:SubtractFrom", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__SubtractFrom ** SOAP_FMAC4 soap_get_PointerTo_mssadh__SubtractFrom(struct soap*, _mssadh__SubtractFrom **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__SubtractFrom
#define soap_read_PointerTo_mssadh__SubtractFrom(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__SubtractFrom(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__AddTo
#define SOAP_TYPE_PointerTo_mssadh__AddTo (24)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__AddTo(struct soap*, _mssadh__AddTo *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__AddTo(struct soap*, const char *, int, _mssadh__AddTo *const*, const char *);
SOAP_FMAC3 _mssadh__AddTo ** SOAP_FMAC4 soap_in_PointerTo_mssadh__AddTo(struct soap*, const char*, _mssadh__AddTo **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__AddTo(struct soap*, _mssadh__AddTo *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__AddTo
#define soap_write_PointerTo_mssadh__AddTo(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__AddTo(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__AddTo(soap, data, "mssadh:AddTo", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__AddTo ** SOAP_FMAC4 soap_get_PointerTo_mssadh__AddTo(struct soap*, _mssadh__AddTo **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__AddTo
#define soap_read_PointerTo_mssadh__AddTo(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__AddTo(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif


#ifndef SOAP_TYPE_PointerTo_mssadh__Clear
#define SOAP_TYPE_PointerTo_mssadh__Clear (20)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_mssadh__Clear(struct soap*, _mssadh__Clear *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_mssadh__Clear(struct soap*, const char *, int, _mssadh__Clear *const*, const char *);
SOAP_FMAC3 _mssadh__Clear ** SOAP_FMAC4 soap_in_PointerTo_mssadh__Clear(struct soap*, const char*, _mssadh__Clear **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_mssadh__Clear(struct soap*, _mssadh__Clear *const*, const char*, const char*);

#ifndef soap_write_PointerTo_mssadh__Clear
#define soap_write_PointerTo_mssadh__Clear(soap, data) ( soap_begin(soap), soap_serialize_PointerTo_mssadh__Clear(soap, data), soap_begin_send(soap) || soap_put_PointerTo_mssadh__Clear(soap, data, "mssadh:Clear", NULL) || soap_end_send(soap), soap->error )
#endif

SOAP_FMAC3 _mssadh__Clear ** SOAP_FMAC4 soap_get_PointerTo_mssadh__Clear(struct soap*, _mssadh__Clear **, const char*, const char*);

#ifndef soap_read_PointerTo_mssadh__Clear
#define soap_read_PointerTo_mssadh__Clear(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_mssadh__Clear(soap, data, NULL, NULL) || soap_end_recv(soap), soap->error )
#endif
